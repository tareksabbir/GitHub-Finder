    ...
    this.profile.innerHTML = `
        <div class="card card-body mb-3">
            <div class="row">
                ...
                <a href="${viewProfile}" target="_blank" class="btn btn-info btn-block mb-4">View Profile</a>
                </div>
                <div class="col-md-9">
        ...
        <h4 class="page-heading mb-3 ml-3" style="color: rgb(0, 0, 0)">Latest Repositories</h4>
        <div id="repos"></div>
        `;
  }
